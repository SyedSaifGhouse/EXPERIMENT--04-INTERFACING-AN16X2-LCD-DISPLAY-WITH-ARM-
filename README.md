...
void lcd_display(){
	Lcd_cursor(&lcd,0,1);
	Lcd_string(&lcd,"SYED SAIF \n");
	Lcd_cursor(&lcd,1,1);
	Lcd_string(&lcd,"212224230286\n");
}
void SystemClock_Config(void)
{
...
![WhatsApp Image 2025-04-23 at 10 23 23 AM](https://github.com/user-attachments/assets/48a39c59-724d-4e99-9aff-b12039f44556)

 
## CIRCUIT DIAGRAM

![WhatsApp Image 2025-04-23 at 10 23 23 AM (1)](https://github.com/user-attachments/assets/6bfaea93-d44d-4b40-9547-3d5198c56d3b)
